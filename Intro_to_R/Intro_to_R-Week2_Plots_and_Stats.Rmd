...
-   Gentoo more different than other species in terms of flippers and body mass
-   Adelie and Chinstrap more similar to each other (smaller with shorter flippers)
-   Adelie and Chinstrap differentiated by bill shape
-   Chinstrip bill length longer than Adelie (further down)
-   Adelie bills deeper than Gentoo and are maybe slightly deeper than Chinstrap (furthest to the left)
...
<!--# START HERE, need to give a bit of background on lm,glm,gam -->
...
there is this isn't an appropriate distribution to assume):
