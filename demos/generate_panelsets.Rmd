...
This markdown details a common workflow simplification in two parts:
 1. Writing a function for repeating plots
 2. Writing a function that will make tabs for each one
...
## Reduce Repetition with Plot Function

One way to reduce the "copy and paste" is with a function for the plot. In this case the only things that change with each iteration is the species we filter the data with, and the plot text it generates.
...
After some googling I came across this tutorial for achieving self-generating panels:
https://interludeone.com/posts/2022-03-04-programmatically-generate-tabs-in-rmarkdown/ 
